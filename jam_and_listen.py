...
class jam_and_listen(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "jam_and_listen", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("jam_and_listen")
        ...
        self.settings = Qt.QSettings("GNU Radio", "jam_and_listen")
        ...
        # Variables
        ##################################################
        self.window_freq = window_freq = 433.910e6
        ...
        self.osmosdr_sink_0.set_center_freq(window_freq, 0)
        self.osmosdr_sink_0.set_freq_corr(0, 0)
        self.osmosdr_sink_0.set_gain(0, 0)
        self.osmosdr_sink_0.set_if_gain(3000, 0)
        self.osmosdr_sink_0.set_bb_gain(30, 0)
        self.osmosdr_sink_0.set_antenna('', 0)
        self.osmosdr_sink_0.set_bandwidth(0, 0)
        self.channels_amp_bal_0 = channels.amp_bal(20)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(8)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\Users\\andre\\Desktop\\jam1.dll', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'C:\\Users\\andre\\Desktop\\prueba_apertura.dll', False)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.channels_amp_bal_0, 0))
        self.connect((self.channels_amp_bal_0, 0), (self.osmosdr_sink_0, 0))
    ...
    def get_window_freq(self):
        return self.window_freq

    def set_window_freq(self, window_freq):
        self.window_freq = window_freq
        self.osmosdr_sink_0.set_center_freq(self.window_freq, 0)
    ...
    def set_target_freq(self, target_freq):
        ...
        self.qtgui_freq_sink_x_2.set_frequency_range(self.target_freq, self.samp_rate)
...
def main(top_block_cls=jam_and_listen, options=None):
